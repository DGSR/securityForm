...
class Name extends React.Component {
    ...
    Click = (e) => {
        ...
        if (this.state.firstName !== "" && this.state.lastName !== "") {
            ...
            this.props.setnam(this.state.firstName);
            this.props.setsurn(this.state.lastName);
            this.props.incr(1)
        } else {
                                ...
                                <div className="jfCard" style={{maxHeight: "794px", maxWidth: "832px"}}>
                                    <div className="jfCard-question">
                                        <label className="jfQuestion-label isCenterAlign"><span
                                            className="jsQuestionLabelContainer">{this.translator.GetPageItem("introduce")}</span><span
                                        ...
                                        <div className="jfQuestion-fields">
                                            <div className="jfField" id="first_0" data-type="first">
                                                <input type="text" id="first_1"
                                                       className="form-textbox jfInput-input hasSublabel inputPatch"
                                                       autoComplete={false}
                                                       value={this.state.firstName} onChange={this.handleNameChange}
                                                       placeholder={this.translator.GetGeneralItem("name")}/>
                                                <label
                                                    className="jfField-sublabel">{this.translator.GetGeneralItem("name")}</label>
                                            </div>
                                            <div className="jfField" id="last_0" data-type="last">
                                                <input type="text" id="last_1"
                                                       className="form-textbox jfInput-input hasSublabel inputPatch"
                                                       autoComplete={false}
                                                       value={this.state.lastName} onChange={this.handleSurnameChange}
                                                       placeholder={this.translator.GetGeneralItem("surname")}/>
                                                <label
                                                    className="jfField-sublabel">{this.translator.GetGeneralItem("surname")}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="jfCard-actions">
                                        <button type="button"
                                                ...
                                                onClick={() => this.BackPage(this.props.type)}>{this.translator.GetGeneralItem("previous")}
                                        </button>
                                        <button type="button"
